     ...
     stage('Deploy Windows'){
            ...
            steps{
                script{
                    ...
                    bat '''
                    curl -u %NEXUS_USERNAME%:%NEXUS_PASSWORD% --upload-file %PROJECT_PATH%/Builds/Windows.zip %NEXUS_IP_ADDRESS%/repository/Windows_Builds/%NEXUS_REPOSITORY%/%ARTIFACT_NAME%
                    '''
                }
            }
        }
